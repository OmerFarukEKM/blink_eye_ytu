import 'package:blink_eye_ytu/firebase_options.dart';
import 'package:blink_eye_ytu/home_page.dart';
import 'package:blink_eye_ytu/loading_page.dart';
...
// herşeyin düzgün olduğundan emin ol anlamına geliyor
  try {
    await Firebase.initializeApp(
        options:
            DefaultFirebaseOptions.currentPlatform); // bu olmaz ise çalışmaz
